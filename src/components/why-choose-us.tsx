...
export default function WhyChooseUs() {
  const benefits = [
    ...
    },
    {
      icon: Truck,
      title: "Fast Delivery",
      description: "Swift and secure shipping across Nigeria",
    },
    {
      icon: Shield,
    ...
    <section className="py-16 px-4 md:px-6 lg:px-8 bg-card/50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">Why Choose Rammys Closet</h2>
          <p className="text-lg text-muted-foreground">Experience luxury cosmetics like never before</p>
        </div>
